 ...
 * @author Zanis
 */
public class SelectCourseSciences extends javax.swing.JPanel {

    /**
     * Creates new form SelectCourseSciences
     */
    public SelectCourseSciences() {
        initComponents();
        showCourseTable();
    }
    ...
    private void initComponents() {
        ...
        jLabel32.setText("پنل انتخاب واحد رشته ي علوم مهندسي");
    ...
    public void showCourseTable(){
        ...
        try{
            ...
            Connection connect = DriverManager.getConnection(url, userName, pass);
            Statement state=connect.createStatement();
            String query="exec SP_showCourse @FieldID = 4";
    ...
    private javax.swing.JTextField txt_L5;
    private javax.swing.JTextField txt_L6;
