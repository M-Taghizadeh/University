 ...
 * @author Zanis
 */
public class SelectCourseCivil extends javax.swing.JPanel {

    /**
     * Creates new form SelectCourseCivil
     */
    public SelectCourseCivil() {
        initComponents();
        showCourseTable();
    }
    ...
    private void initComponents() {
        ...
        jLabel32.setText("پنل انتخاب واحد رشته ي مهندسی عمران");
    ...
    public void showCourseTable(){
        ...
        try{
            ...
            Connection connect = DriverManager.getConnection(url, userName, pass);
            Statement state=connect.createStatement();
            String query="exec SP_showCourse @FieldID = 2";
